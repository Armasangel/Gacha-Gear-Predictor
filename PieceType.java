...
public enum PieceType {
    ...
    PieceType(List<MainStatType> validMainStats) {
        this.validMainStats = validMainStats;
    }

    public List<MainStatType> getValidMainStats() { return validMainStats; }
    
    public boolean isValidMainStat(MainStatType mainStat) {
        return validMainStats.contains(mainStat);
    }
